...
`異なる体格の厳格TPose間でのポーズ転送` を 厳格リターゲット と呼ぼう。
...
* 厳格TPose は 曖昧TPose や Aスタンスからプログラムで機械的に作れる。
  ...
  * どんなポーズでもよいか？
    ...
    * 曖昧TPose が `骨格の姿勢の個性` を持っていると考えると、`曖昧 T-Pose` がよいと言える。
...
肩と並んで人体の骨というよりモデリングの都合が全面に出てきそう。
footの斜めさは個体差を残す必要がある。
toes を非連続として強制 TPose 時に伸ばさないのがいいかも。
